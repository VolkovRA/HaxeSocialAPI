...
typedef Support =
{
     ...
     * Не может быть `null`
     */
    var post:PostSupport;

    /**
     * Параметры поддержки уровней игроков.  
     * Не может быть `null`
     */
    var setLevel:SetLevelSupport;

    /**
     * Параметры поддержки очков игроков.  
     * Не может быть `null`
     */
    var setScores:SetScoresSupport;
...
/**
 * Параметры установки достигнутого уровня игроком.
 */
typedef SetLevelSupport =
{
    /**
     * Флаг доступности функционала.  
...
/**
 * Параметры установки достигнутого прогресса игроком по очкам.
 */
typedef SetScoresSupport =
{
    /**
     * Флаг доступности функционала.  
